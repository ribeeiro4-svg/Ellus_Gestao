      ...
      <div className="flex flex-col gap-6">
        <div className="page-header flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="hidden lg:flex items-center gap-6 bg-white p-3 px-6 rounded-2xl border border-gray-100 shadow-sm">
            <div className="flex flex-col"><span className="text-[9px] font-black text-emerald-500 uppercase tracking-wider">Entradas (+)</span><span className="text-sm font-black text-emerald-700">{fmtR(auditStats.credits)}</span></div>
            <div className="w-px h-8 bg-gray-100" /><div className="flex flex-col"><span className="text-[9px] font-black text-red-400 uppercase tracking-wider">Saídas (-)</span><span className="text-sm font-black text-red-600">{fmtR(auditStats.debits)}</span></div>
            <div className="w-px h-8 bg-gray-100" /><div className="flex flex-col"><span className="text-[9px] font-black text-gray-400 uppercase tracking-wider">Saldo Líquido</span><span className={`text-sm font-black ${auditStats.balance >= 0 ? 'text-indigo-900' : 'text-red-600'}`}>{fmtR(auditStats.balance)}</span></div>
            <div className="w-px h-8 bg-gray-100" /><div className="flex flex-col"><span className="text-[9px] font-black text-amber-500 uppercase tracking-wider">Duplicados</span><span className="text-sm font-black text-amber-600">{auditStats.duplicates}</span></div>
          </div>
        </div>
