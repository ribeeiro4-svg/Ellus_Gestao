...
function FinanceiroPageContent() {
  ...
  // Estados Base
  const [activeTab, setActiveTab] = useState<'calendario' | 'conciliacao'>('calendario')
      ...
      <div className="flex flex-col xl:flex-row items-start xl:items-center justify-between bg-white py-3 px-5 rounded-2xl border border-slate-100 shadow-sm gap-4">
        <div className="flex items-center gap-4 pl-2">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-xl font-black text-slate-800 tracking-tight leading-none mb-0.5">Conciliação Bancária</h1>
            <p className="text-[9px] font-extrabold text-slate-400 uppercase tracking-widest">Sincronização OFX, Cora e Fiscal</p>
          </div>
        </div>
