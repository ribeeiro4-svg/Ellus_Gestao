...
export default function KpiCard({ 
  ...
  return (
    <div 
      className={`kpi-card bg-white border border-slate-100 rounded-2xl p-5 shadow-sm hover:shadow-xl transition-all hover:-translate-y-1 relative overflow-visible group border-t-4 ${borderColors[category]}`}
