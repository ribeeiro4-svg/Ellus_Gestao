    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-row flex-nowrap gap-2 overflow-x-auto pb-2 scrollbar-hide">
        {kpis.map((kpi, i) => {
          const Icon = kpi.icon
          return (
            <div key={i} className="bg-white border border-slate-100 py-6 px-4 rounded-xl shadow-sm hover:shadow-md transition-all flex-1 min-w-[125px]">
              ...
              <div className="text-lg font-black text-slate-800" style={{ color: i > 3 ? kpi.color : undefined }}>
                {kpi.value}
              </div>
            </div>
          )
