...
export const DESTINACOES_ITEM = [
  ...
  { codigo: '31', descricao: '3.1 — Uso ou Consumo (Bens Duráveis)', color: 'slate' },
  { codigo: '41', descricao: '4.1 — Ativo Imobilizado: Máquinas e Equipamentos', color: 'purple' },
  { codigo: '42', descricao: '4.2 — Ativo Imobilizado: Veículos', color: 'purple' },
  { codigo: '43', descricao: '4.3 — Ativo Imobilizado: Móveis e Utensílios', color: 'purple' },
  { codigo: '44', descricao: '4.4 — Ativo Imobilizado: Equipamentos de Informática', color: 'purple' },
  { codigo: '45', descricao: '4.5 — Ativo Imobilizado: Edificações e Benfeitorias', color: 'purple' },
  { codigo: '49', descricao: '4.9 — Ativo Imobilizado: Outros', color: 'purple' },
