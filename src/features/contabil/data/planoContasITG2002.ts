...
export const PLANO_CONTAS_ITG2002: PlanoContasItem[] = [
  ...
  { codigo:'2.1.1.06', descricao:'Provisão para Férias a Pagar', nivel:4, tipo:'analitica', natureza:'credora', classificacao:'passivo', aceita_lancamentos:true },
  { codigo:'2.1.1.07', descricao:'Provisão para 13º Salário a Pagar', nivel:4, tipo:'analitica', natureza:'credora', classificacao:'passivo', aceita_lancamentos:true },
  { codigo:'2.1.1.08', descricao:'Bolsa de Estágio a Pagar', nivel:4, tipo:'analitica', natureza:'credora', classificacao:'passivo', aceita_lancamentos:true },
  { codigo:'2.1.1.09', descricao:'Auxílio Alimentação — Estagiário a Pagar', nivel:4, tipo:'analitica', natureza:'credora', classificacao:'passivo', aceita_lancamentos:true },
  { codigo:'2.1.1.10', descricao:'Auxílio Transporte — Estagiário a Pagar', nivel:4, tipo:'analitica', natureza:'credora', classificacao:'passivo', aceita_lancamentos:true },
  { codigo:'2.1.1.11', descricao:'Pró-Labore a Pagar — Diretoria', nivel:4, tipo:'analitica', natureza:'credora', classificacao:'passivo', aceita_lancamentos:true },
  ...
  { codigo:'4.1.1.01', descricao:'Mensalidades Sociais', nivel:4, tipo:'sintetica', natureza:'credora', classificacao:'ingresso' },
  { codigo:'4.1.1.01.001', descricao:'Mensalidades de Associados', nivel:5, tipo:'analitica', natureza:'credora', classificacao:'ingresso', aceita_lancamentos:true },
  { codigo:'4.1.1.01.002', descricao:'Taxas de Adesão de Novos Membros', nivel:5, tipo:'analitica', natureza:'credora', classificacao:'ingresso', aceita_lancamentos:true },
  
  { codigo:'4.1.2', descricao:'DOAÇÕES E SUBVENÇÕES', nivel:3, tipo:'sintetica', natureza:'credora', classificacao:'ingresso' },
  { codigo:'4.1.2.01', descricao:'Doações de Pessoas Físicas', nivel:4, tipo:'sintetica', natureza:'credora', classificacao:'ingresso' },
  { codigo:'4.1.2.01.001', descricao:'Doações Espontâneas — PF', nivel:5, tipo:'analitica', natureza:'credora', classificacao:'ingresso', aceita_lancamentos:true },
  
  { codigo:'4.2', descricao:'OUTROS INGRESSOS OPERACIONAIS', nivel:2, tipo:'sintetica', natureza:'credora', classificacao:'ingresso' },
  { codigo:'4.2.1', descricao:'SERVIÇOS E EVENTOS', nivel:3, tipo:'sintetica', natureza:'credora', classificacao:'ingresso' },
  { codigo:'4.2.1.01', descricao:'Ingressos de Cursos e Treinamentos', nivel:4, tipo:'sintetica', natureza:'credora', classificacao:'ingresso' },
  { codigo:'4.2.1.01.001', descricao:'Inscrições em Cursos Livres', nivel:5, tipo:'analitica', natureza:'credora', classificacao:'ingresso', aceita_lancamentos:true },

  // ── 5 DISPÊNDIOS (DESPESAS) ────────────────────────────────────────────────
  { codigo:'5', descricao:'DISPÊNDIOS', nivel:1, tipo:'sintetica', natureza:'devedora', classificacao:'despesa' },
  { codigo:'5.1', descricao:'DISPÊNDIOS DAS ATIVIDADES FIM', nivel:2, tipo:'sintetica', natureza:'devedora', classificacao:'despesa' },
  { codigo:'5.1.1', descricao:'DISPÊNDIOS COM PESSOAL — ATIV. FIM', nivel:3, tipo:'sintetica', natureza:'devedora', classificacao:'despesa' },
  { codigo:'5.1.1.01', descricao:'Remuneração e Benefícios — Ativ. Fim', nivel:4, tipo:'sintetica', natureza:'devedora', classificacao:'despesa' },
  { codigo:'5.1.1.01.001', descricao:'Salários e Ordenados — Ativ. Fim', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.1.1.01.002', descricao:'Encargos Sociais s/ Folha — Ativ. Fim', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.1.1.03', descricao:'Bolsas de Estágio — Ativ. Fim', nivel:4, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.1.1.04', descricao:'Auxílio Alimentação — Estagiário Ativ. Fim', nivel:4, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.1.1.05', descricao:'Auxílio Transporte — Estagiário Ativ. Fim', nivel:4, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },

  { codigo:'5.2', descricao:'DISPÊNDIOS ADMINISTRATIVOS E GERAIS', nivel:2, tipo:'sintetica', natureza:'devedora', classificacao:'despesa' },
  { codigo:'5.2.1', descricao:'PESSOAL ADMINISTRATIVO', nivel:3, tipo:'sintetica', natureza:'devedora', classificacao:'despesa' },
  ...
  { codigo:'5.2.1.03', descricao:'Encargos Sociais — Admin. (INSS patronal pro labore)', nivel:4, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.1.04', descricao:'Bolsas de Estágio — Admin.', nivel:4, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.1.05', descricao:'Auxílio Alimentação — Estagiário Admin.', nivel:4, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.1.06', descricao:'Auxílio Transporte — Estagiário Admin.', nivel:4, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  
  { codigo:'5.2.2', descricao:'MANUTENÇÃO E INFRAESTRUTURA', nivel:3, tipo:'sintetica', natureza:'devedora', classificacao:'despesa' },
  { codigo:'5.2.2.01', descricao:'Serviços de Utilidade Pública', nivel:4, tipo:'sintetica', natureza:'devedora', classificacao:'despesa' },
  { codigo:'5.2.2.01.001', descricao:'Energia Elétrica Sede', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.2.01.002', descricao:'Água e Esgoto Sede', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.2.01.003', descricao:'Serviços de Telecomunicações', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.2.01.004', descricao:'Materiais de Escritório e Expediente', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.2.01.005', descricao:'Materiais de Limpeza e Consumo da Sede', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.2.01.006', descricao:'Manutenção de Sistemas e Software', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.2.01.007', descricao:'Serviços de Terceiros - Pessoa Jurídica', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.2.01.008', descricao:'Assessoria Contábil e Jurídica', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.2.01.009', descricao:'Despesas com Gráfica e Impressos', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.2.01.010', descricao:'Aluguéis de Máquinas e Equipamentos', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.2.01.011', descricao:'Manutenção de Infraestrutura e Reparos', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  
  { codigo:'5.2.3', descricao:'DISPÊNDIOS FINANCEIROS', nivel:3, tipo:'sintetica', natureza:'devedora', classificacao:'despesa' },
  { codigo:'5.2.3.01', descricao:'Tarifas e Comissões Bancárias', nivel:4, tipo:'sintetica', natureza:'devedora', classificacao:'despesa' },
  { codigo:'5.2.3.01.001', descricao:'Taxas de Manutenção de Conta', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.3.01.002', descricao:'Taxas s/ Boletos e Recebimentos', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  
  { codigo:'5.2.4', descricao:'DEPRECIAÇÕES E AMORTIZAÇÕES', nivel:3, tipo:'sintetica', natureza:'devedora', classificacao:'despesa' },
  { codigo:'5.2.4.01', descricao:'Cotas de Depreciação do Exercício', nivel:4, tipo:'sintetica', natureza:'devedora', classificacao:'despesa' },
  { codigo:'5.2.4.01.001', descricao:'Depreciação de Edificações', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
  { codigo:'5.2.4.01.002', descricao:'Depreciação de Móveis e Equipamentos', nivel:5, tipo:'analitica', natureza:'devedora', classificacao:'despesa', aceita_lancamentos:true },
]
