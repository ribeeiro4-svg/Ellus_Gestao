...
export default function FinancialKpiGrid({ kpis, onNew }: FinancialKpiGridProps) {
  ...
  return (
    <div className="flex items-center gap-4 mb-8 w-full">
      ...
      <button onClick={onNew} className="px-6 py-5 bg-emerald-600 text-white rounded-[24px] font-black text-xs hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-200 whitespace-nowrap self-stretch flex items-center">
        + NOVO LANÇAMENTO
      </button>
    </div>
  )
